...
DATA = {
    ...
    "hero": {
        ...
        "summary": (
            "Passionate and skilled Game Developer with 4 years of experience in Unreal Engine, "
            "specializing in AI systems, single-player narrative games, and VR development. "
            "With hands-on experience in developing AAA-quality games, including projects on Steam, "
            "I possess in-depth expertise in game mechanics, optimization, and AI programming. "
            "My current goal is to secure a position at a leading game development company, where I can "
            "continue to work with Unreal Engine, contributing to cutting-edge game AI, VR, and immersive "
            "gameplay systems."
        ),
        "logo": "TR",
        "primary_cta": {
        ...
        "secondary_cta": {
            "label": "Download CV",
            "href": "/static/files/Mohammed_Tasfiqur_Rahman_CV.pdf",
        },
        "socials": [
            {
                "label": "GitHub",
    ...
    "about": {
        ...
        "content": [
            (
                "I am a passionate Unreal Engine Game Developer with 4+ years of experience specializing in "
                "AI systems, single-player narrative design, VR development, and metaverse-focused projects. "
                "I’ve contributed to AAA-quality productions, including Steam-published titles, and have led "
                "teams in delivering optimized, high-performance virtual worlds. I thrive in collaborative "
                "environments and aim to contribute to cutting-edge projects at leading game development studios."
            ),
        ...
        "items": [
            {
                ...
                "description": (
                    "A third-person action prototype featuring dynamic combat, cinematic cameras, "
                    "and reactive environments of Bangladesh Liberation War."
                ),
                "tech": ["Unreal Engine 5", "C++", "Multiplayer"],
                "youtube_id": "IBL3QXyYtl8",
                "links": [
                    {
                        "label": "YouTube",
            ...
            },
            {
                ...
                "role": "Horror Game",
                "description": "An immersive horror game inspired by Outlast.",
            ...
            },
            {
                ...
                "description": "A simple character selection mode with combat.",
                "tech": ["Unreal Engine", "C++"],
            ...
            },
            {
                ...
                "description": "A simple archery mechanism.",
                "tech": ["Unreal Engine", "C++"],
            ...
            },
            {
                ...
                "description": "A simple traffic simulation.",
                "tech": ["Unreal Engine", "C++"],
        ...
        "items": [
            {
                ...
                "href": "https://example.com/ue-cpp-cert",
            },
        ],
    },
